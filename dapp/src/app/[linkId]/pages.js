...
import { getLink, payLink } from "./services/Web3Service.js";
    ...
    return (
        <div className="container px-4 py-5">
            <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                <div className="col-6">
                    <img src="https://plus.unsplash.com/premium_vector-1750243176461-e284187f6bfb?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="d-block mx-lg-auto img-fluid" width="700" />
                </div>
                <div className="col-6">
                    ...
                    <div className="row mb-3">
                        <div className="col-6">
                            <button type="button" className="btn btn-primary w-100 h-100" onClick={btnAccessClick}>
                                <img src="/MetaMask-icon-fox-with-margins.svg" width={32} className="me-2" />
